...
function Profile() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="__container bg-base-200 flex flex-row w-full h-full p-12 gap-10 rounded-2xl">
        <div className="inner__container bg-base-100 w-1/3 min-w-1/2 p-12 rounded-3xl flex flex-col justify-between">
